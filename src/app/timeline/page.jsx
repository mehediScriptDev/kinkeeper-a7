    ...
    <div className="mt-10 md:mt-20 max-w-7xl w-11/12 mx-auto">
      ...
      <div className="flex flex-col gap-4">
        <div className="bg-white shadow p-4 flex gap-4 items-center rounded-lg border border-[#E9E9E9]">
          ...
          <div>
            <p className="text-xl text-[#244D3F] font-medium">Video <span className="text-lg font-normal text-[#64748B]">with Tom Baker</span></p>
        ...
        <div className="bg-white shadow p-4 flex gap-4 items-center rounded-lg border border-[#E9E9E9]">
          ...
          <div>
            <p className="text-xl text-[#244D3F] font-medium">Text <span className="text-lg font-normal text-[#64748B]">with Tom Baker</span></p>
            <p className="text-base text-[#64748B]">March 29, 2026</p>
          </div>
        </div>
        <div className="bg-white shadow p-4 flex gap-4 items-center rounded-lg border border-[#E9E9E9]">
          ...
          <div>
            <p className="text-xl text-[#244D3F] font-medium">Call <span className="text-lg font-normal text-[#64748B]">with Tom Baker</span></p>
            <p className="text-base text-[#64748B]">March 29, 2026</p>
          </div>
        </div>
        <div className="bg-white shadow p-4 flex gap-4 items-center rounded-lg border border-[#E9E9E9]">
